...
int main(int argc, char** argv)
{
   try {
      ...
      // Modified by wschoi
      app().set_default_data_dir(root / "osbio" / nodeos::config::node_executable_name / "data" );
      app().set_default_config_dir(root / "osbio" / nodeos::config::node_executable_name / "config" );
